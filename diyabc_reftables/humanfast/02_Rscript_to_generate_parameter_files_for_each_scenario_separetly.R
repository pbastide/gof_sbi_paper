...
#
# REQUIREMENTS:
# - File "headerRF_for_diyabc_generated_reftableRF_human_fast.txt"
# - File "diyabc_generated_reftableRF_human_fast.bin"
#   Generated by script "01_Generate_reftableRF.bin_for_diyabc_generated_reftableRF_human_fast.sh".

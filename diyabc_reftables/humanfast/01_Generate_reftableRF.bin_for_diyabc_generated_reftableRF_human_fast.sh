...
# Make the script executable by running the command: chmod +x 01_Generate_reftableRF.bin_for_diyabc_generated_reftableRF_human_fast.sh
# Run the script with: ./01_Generate_reftableRF.bin_for_diyabc_generated_reftableRF_human_fast.sh
#
# REQUIREMENTS:
...
# - data file human_snp_all22chr_hudson_10IndPerPop.snp
# - header file headerRF_for_diyabc_generated_reftableRF_human_fast.txt (which has to be renamed headerRF.txt)
#
#!/bin/bash
